...
const PROJECTS: Project[] = [
  ...
  {
    number: '02',
    name: 'RAG Performance Framework',
  ...
  {
    number: '03',
    name: 'Onboarding & Employer Brand Revamp',
  ...
  return (
    <div className="h-[85vh]">
      <div className="sticky top-24 md:top-32">
        <motion.div
          className="flex flex-col gap-4 rounded-[40px] border-2 border-[#D7E2EA] bg-[#0C0C0C] p-4 sm:gap-6 sm:rounded-[50px] sm:p-6 md:rounded-[60px] md:p-8"
          style={{ scale, position: 'relative', top: `${index * 28}px` }}
        >
